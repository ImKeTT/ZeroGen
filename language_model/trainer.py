    ...
    while effective_batch_acm < total_steps:
        ...
        if effective_batch_acm % save_every == 0 and save_valid:
            ...
            if one_val_loss < min_val_loss:
                ...
                save_name = '{}_training_step_{}_train_mle_loss_{}_train_cl_loss_{}_dev_loss_{}_dev_ppl_{}'.format(args.task, effective_batch_acm,
                ...
                for fname in os.listdir(test_output_dir):
                    if fname.startswith(f'{args.task}_training_step'):
